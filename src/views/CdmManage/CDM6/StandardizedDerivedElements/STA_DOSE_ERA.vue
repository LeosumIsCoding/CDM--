          ...
          <div class="tableBox">
            <ul>
              ...
              <li>
                ...
                <span>	概念 ID 表示特定药物成分的单位。</span>
                <span></span>
                <span>integer</span>
              </li>
              <li>
                <span>dose_value</span>
                <span>drug_ingredient剂量的数值。</span>
                <span></span>
                <span>float</span>
              </li>
              <li>
                <span>dose_era_start_datetime</span>
                <span>该人开始特定剂量的日期，自任何先前暴露以来至少31天。</span>
                <span></span>
                <span>datetime</span>
              </li>
              <li>
                <span>dose_era_end_datetime</span>
                <span></span>
                <span>该人不再暴露于特定药物成分剂量的日期。如果剂量记录之间有31天或更长时间，则一个时代结束。</span>
                <span>datetime</span>
              </li>
            </ul>
          </div>
