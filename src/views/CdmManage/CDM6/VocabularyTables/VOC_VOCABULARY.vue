          ...
          <div class="tableBox">
            <ul>
              ...
              <li>
                ...
                <span>	每个词汇的唯一标识符，例如 ICD9CM、SNOMED、访问。</span>
                <span></span>
                <span>	varchar(20)</span>
              </li>
              <li>
                <span>vocabulary_name</span>
                <span>描述词汇的名称，例如国际疾病分类，第九修订版，临床修改，第1卷和第2卷（NCHS）等。</span>
                <span></span>
                <span>	varchar(255)</span>
              </li>
              <li>
                <span>vocabulary_reference</span>
                <span>外部参考文档或关于词汇表的可用下载。</span>
                <span></span>
                <span>	varchar(255)	</span>
              </li>
              <li>
              ...
              <li>
                <span>vocabulary_concept_id</span>
                <span>表示词汇记录所属的词汇的概念。</span>
                <span></span>
                <span>	integer</span>
              </li>
